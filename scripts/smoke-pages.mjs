...
for (const path of ['/api/workspace', '/api/commands']) {
...
console.log(`PASS ${base}: login and expanded-text routes, configured API, anonymous/cross-origin denial. No authenticated operations tested.`);
