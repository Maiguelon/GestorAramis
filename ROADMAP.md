...
| Bloque | Dependencias | Entrega | Aceptación | Estado al 2026-09-12 |
|---|---|---|---|---|
...
| C03 Acceso | C02 | Sesión equipo, luego OTP, roles, enlaces scope/revocación | Aislamiento API entre clientes, recuperación y correo real | Miguel, Eliana y Eric habilitados como equipo; primer login de Eliana/Eric pendiente; OTP/enlaces remotos pendientes |
| C04 Drive | Inicia C01, integra C02/C03 | OAuth, selección, subidas, streaming privado, versiones | Video real reanudado y reproducido en teléfono; permisos y cuota | Interno integrado y probado contra Google en escritorio: carga nueva/recuperación, preview/seek, individual y ZIP; pendientes teléfono, segunda identidad, cuota, OAuth producción, Picker y versiones cliente |
| C05 Panel interno | Inicia C01, integra C02/C03 | Semana, bloqueos, filtros, alta, responsable, fechas, detalle | Hermana identifica quién debe avanzar; persistencia y errores | Planificación y materiales reales; entrada de Diseño implementada y probada, pendiente feedback Miguel/Eliana |
...
| C08 Material | C02/C03/C04 | Pedido, varios archivos, progreso, verificación interna | Fallos parciales, recibido≠completo, reanudación real | Material del equipo real con tres videos sintéticos verificados; pendientes teléfono, tomas completas y pedidos remotos de clientes |
