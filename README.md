...
6. En Detalles, **Expandir guion y texto** abre una pestaña de lectura grande con el contenido guardado. Se actualiza cuando guardan desde la pieza; incluye copiar texto.
7. La revisión/aprobación anterior sigue disponible, sin ampliaciones de la vista cliente en este bloque. La aprobación continúa vinculada a una versión exacta.
